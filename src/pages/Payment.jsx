...
export default function Payment() {
  ...
  return (
    <section className="max-w-md mx-auto px-6 py-20">
      <p className="font-mono text-[11px] uppercase tracking-widest text-clay mb-2">Paiement securise</p>
      ...
      <form onSubmit={submit} className="bg-white border border-border rounded-2xl p-5 grid gap-3">
        <div className="grid grid-cols-2 gap-3">
          <input required placeholder="Prenom" value={form.firstName} onChange={update("firstName")}
            className="bg-cream border border-border rounded-xl px-3 py-2.5 text-sm outline-none focus:border-tomato" />
        ...
        <p className="text-[11px] text-barklight text-center">
