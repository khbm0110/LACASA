...
export default function BlogPost() {
  ...
  if (post === undefined) return <div className="max-w-2xl mx-auto px-6 py-24 text-pale/70">Chargement...</div>
  if (!post) return <div className="max-w-2xl mx-auto px-6 py-24 text-pale/70">Article introuvable.</div>

  return (
    <article className="max-w-2xl mx-auto px-6 md:px-8 py-20">
      <Link to="/blog" className="text-sm text-pale/70 mb-8 inline-block">&larr; Retour au blog</Link>
      ...
      <div className="text-pale/70 leading-relaxed whitespace-pre-line">{post.content}</div>
    </article>
  )
}
